...
function carregarAlimentos() {
    ...
    fetch('../backend/recebedor/listarAlimentos.php')
        .then(function(r) {
...
function confirmarReserva() {
    ...
    fetch('../backend/recebedor/criarReserva.php', {
        method: 'POST',
...
function carregarReservas() {
    ...
    fetch('../backend/recebedor/listarReservas.php')
        .then(function(r) {
            if (r.status === 401) { window.location.href = '../login.html'; return null; }
            return r.json();
        })
...
function cancelarReserva(idReserva, card) {
    fetch('../backend/recebedor/cancelarReserva.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
document.getElementById('btnEnviarDenuncia').addEventListener('click', function() {
    ...
    fetch('../backend/recebedor/criarDenuncia.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            motivo:           motivo,
...
function carregarConta() {
    ...
    fetch('../backend/recebedor/minhaConta.php')
        .then(function(r) {
            if (r.status === 401) { window.location.href = '../login.html'; return null; }
            return r.json();
        })
...
function salvarConta() {
    ...
    fetch('../backend/recebedor/atualizarConta.php', {
        method: 'POST',
...
async function verificarAutenticacaoEIniciar() {
    try {
        ...
        const respostaAutenticacao = await fetch('../backend/recebedor/minhaConta.php');
